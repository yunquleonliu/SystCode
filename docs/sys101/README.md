...
| 7 | **[Lock-free Stack](../../problems/sys101/07_lock_free_stack)** | Thread-safe stack without mutexes. | ABA Problem, CAS Loops | ⬜ |
| 8 | **[Thread Pool](../../problems/sys101/08_thread_pool)** | Fixed-size worker pool for task execution. | Condition Variables, Task Queues | ⬜ |
| 9 | **[Read-Write Lock](../../problems/sys101/09_read_write_lock)** | Implement a writer-preferred RW lock. | Starvation Prevention, State Flags | ⬜ |
| 10 | **[Barrier](../../problems/sys101/10_barrier)** | Thread synchronization barrier. | Thread Counting, Release Points | ⬜ |
...
| # | Problem | Description | Key Concepts | Status |
|---|---------|-------------|--------------|:---:|
| 11 | **[Page Table Walk](../../problems/sys101/11_page_table_walk)** | Simulate virtual to physical address translation. | Multi-level Pages, MMU Simulation | ⬜ |
| 12 | **[Mmap Copy](../../problems/sys101/12_mmap_copy)** | High-perf file copy using memory mapping. | `mmap`, `msync`, Page Faults | ⬜ |
| 13 | **[ELF Parser](../../problems/sys101/13_elf_header_parser)** | Parse binary headers to find entry points. | Struct Mapping, Endianness | ⬜ |
| 14 | **[Ring Buffer](../../problems/sys101/14_ring_buffer)** | Lock-free circular buffer for IPC/Audio. | Producer/Consumer Indices, Modulo | ⬜ |
| 15 | **[User Context Switch](../../problems/sys101/15_user_space_context_switch)** | Simulate coroutine context switching. | `setjmp`/`longjmp`, Register Save/Restore | ⬜ |
...
| # | Problem | Description | Key Concepts | Status |
|---|---------|-------------|--------------|:---:|
| 16 | **[Epoll Echo Server](../../problems/sys101/16_epoll_echo_server)** | High-concurrency event-driven server. | ET vs LT, Non-blocking I/O | ⬜ |
| 17 | **[Endianness Swap](../../problems/sys101/17_endianness_swap)** | Network byte order conversion for 64-bit ints. | Bit Shifts, Masking | ⬜ |
| 18 | **[HTTP/1.1 Parser](../../problems/sys101/18_http_parser)** | Zero-copy HTTP header parsing. | FSM, String Optimization | ⬜ |
| 19 | **[TCP Flow Control](../../problems/sys101/19_simple_tcp_flow_control)** | Simulate sliding window protocol. | Window Updates, ACKs | ⬜ |
| 20 | **[Raw Socket ICMP](../../problems/sys101/20_raw_socket_icmp)** | Construct and send Ping packets manually. | Checksums, Raw Sockets | ⬜ |
...
| # | Problem | Description | Key Concepts | Status |
|---|---------|-------------|--------------|:---:|
| 21 | **[2PC (Two-Phase Commit)](../../problems/sys101/21_two_phase_commit)** | Distributed transaction coordinator simulation. | Prepare/Commit Phases, Timeouts | ⬜ |
| 22 | **[Consistent Hashing](../../problems/sys101/22_consistent_hashing)** | Distributed cache node mapping. | Hash Ring, Virtual Nodes | ⬜ |
| 23 | **[Vector Clock](../../problems/sys101/23_vector_clock)** | Causality tracking in distributed events. | Version Vectors, Partial Ordering | ⬜ |
| 24 | **[Gossip Protocol](../../problems/sys101/24_gossip_protocol)** | Epidemic status propagation. | Randomized Fanout, Convergence | ⬜ |
| 25 | **[Raft Heartbeat](../../problems/sys101/25_raft_heartbeat)** | Leader election heartbeat mechanism. | Timers, Lease Management | ⬜ |
...
| # | Problem | Description | Key Concepts | Status |
|---|---------|-------------|--------------|:---:|
| 26 | **[Round-Robin Scheduler](../../problems/sys101/26_round_robin_scheduler)** | Runqueue simulation with time slicing. | Preemption, Quantum, Task States | ⬜ |
| 27 | **[Simple File System](../../problems/sys101/27_simple_file_system)** | Inode-based FS implementation on a virtual disk. | Inodes, Bitmaps, Superblock | ⬜ |
| 28 | **[LSM-Tree](../../problems/sys101/28_lsm_tree_storage)** | Log-Structured Merge Tree basics (Write path). | MemTable, SSTable, Write Amplification | ⬜ |
| 29 | **[Mini Container](../../problems/sys101/29_mini_container)** | Process isolation using Namespaces. | `clone`, `unshare`, PID/Mount Namespace | ⬜ |
| 30 | **[Mini Debugger](../../problems/sys101/30_mini_debugger)** | Tracer using `ptrace` syscall. | Registers, Breakpoints, System Calls | ⬜ |
