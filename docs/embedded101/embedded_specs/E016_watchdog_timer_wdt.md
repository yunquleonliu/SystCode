# E016: Watchdog Timer (WDT)

## Objective
- Implement a mechanism to refresh the watchdog and debug a simulated "hang".
...
- C source: [../../problems/embedded101/embedded/E016_watchdog_timer_wdt/solution.c](https://github.com/yunquleonliu/SystCode/blob/main/problems/embedded101/embedded/E016_watchdog_timer_wdt/solution.c)
