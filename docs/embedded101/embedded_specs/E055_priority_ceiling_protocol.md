# E055: Priority Ceiling Protocol

## Objective
- Alternative to inheritance for avoiding inversion.
...
- Think of **Priority Ceiling Protocol** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E055.
...
printf("[E055] realtime_core %s\n", ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E055_priority_ceiling_protocol/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E055_priority_ceiling_protocol/solution.c)
