# E053: Interrupt Latency Measurement

## Objective
- Measure the time from HW trigger to ISR entry using GPIO.

## Background
- Module: Advanced Concurrency & Real-Time (10 Problems)
...
- Think of **Interrupt Latency Measurement** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E053.
...
printf("[E053] realtime_core %s\n", ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E053_interrupt_latency_measurement/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E053_interrupt_latency_measurement/solution.c)
