...
## Objective
- Simulate a USB mouse movement (Device descriptor setup).
...
- Think of **USB HID Mouse** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E078.
...
int ok = cs != 0;
printf("[E078] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E078_usb_hid_mouse/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E078_usb_hid_mouse/solution.c)
