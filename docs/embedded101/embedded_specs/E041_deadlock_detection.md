...
- Think of **Deadlock Detection** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E041.
...
int ok = (winner == 1);
printf("[E041] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E041_deadlock_detection/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E041_deadlock_detection/solution.c)
