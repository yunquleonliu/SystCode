# E067: XMODEM/YMODEM Protocol

## Objective
- Implement file transfer over UART.
...
- Think of **XMODEM/YMODEM Protocol** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E067.
...
int ok = cs != 0;
printf("[E067] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E067_xmodem_ymodem_protocol/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E067_xmodem_ymodem_protocol/solution.c)
