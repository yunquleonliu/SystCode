# E075: TCP State Machine (Simplified)

## Objective
- Implement the handshake (SYN, SYN-ACK, ACK).
...
- Think of **TCP State Machine (Simplified)** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E075.
...
int ok = cs != 0;
printf("[E075] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E075_tcp_state_machine_simplified/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E075_tcp_state_machine_simplified/solution.c)
