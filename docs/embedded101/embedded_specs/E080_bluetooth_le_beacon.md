# E080: Bluetooth LE Beacon

## Objective
- Setup advertising data packet structure.
...
- Think of **Bluetooth LE Beacon** as a system behavior problem before it is a coding problem.
...
int ok = cs != 0;
printf("[E080] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E080_bluetooth_le_beacon/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E080_bluetooth_le_beacon/solution.c)
