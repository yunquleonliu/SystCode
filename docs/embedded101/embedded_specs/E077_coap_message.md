...
## Objective
- Construct a constrained application protocol message.
...
- Think of **CoAP Message** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E077.
...
int ok = cs != 0;
printf("[E077] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E077_coap_message/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E077_coap_message/solution.c)
