# E106: Interrupt Moderation (NAPI)

## Objective
- Implement a hybrid polling/interrupt loop to handle high packet rates without ISR storms.
...
- Think of **Interrupt Moderation (NAPI)** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E106.
...
Queue q = {0};
uint32_t value = 0;
int ok = push(&q, 0x100u + 106) && pop(&q, &value) && value == (0x100u + 106);
printf("[E106] hpio_core val=%u %s\n", value, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E106_interrupt_moderation_napi/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E106_interrupt_moderation_napi/solution.c)
