# E068: Modbus RTU Slave

## Objective
- Implement the state machine for Modbus request/response.
...
- Think of **Modbus RTU Slave** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E068.
...
int ok = cs != 0;
printf("[E068] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E068_modbus_rtu_slave/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E068_modbus_rtu_slave/solution.c)
