...
## Objective
- Implement a virtual serial port over USB.
...
- Think of **USB CDC-ACM** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E079.
...
int ok = cs != 0;
printf("[E079] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E079_usb_cdc_acm/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E079_usb_cdc_acm/solution.c)
