# E045: Critical Sections

## Objective
- Implement `ENTER_CRITICAL` and `EXIT_CRITICAL` disabling interrupts safely (nesting support).
...
- Think of **Critical Sections** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E045.
...
int ok = (winner == 1);
printf("[E045] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E045_critical_sections/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E045_critical_sections/solution.c)
