# E039: Worker/Bottom-Half threads

## Objective
- Offload ISR work to a high-priority task.
...
- Think of **Worker/Bottom-Half threads** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E039.
...
int ok = (winner == 1);
printf("[E039] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E039_worker_bottom_half_threads/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E039_worker_bottom_half_threads/solution.c)
