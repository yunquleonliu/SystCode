# E013: UART Interrupt-Based Ring Buffer

## Objective
- Upgrade the UART driver to use a circular buffer and interrupts.
...
- C source: [../../problems/embedded101/embedded/E013_uart_interrupt_based_ring_buffer/solution.c](https://github.com/yunquleonliu/SystCode/blob/main/problems/embedded101/embedded/E013_uart_interrupt_based_ring_buffer/solution.c)
