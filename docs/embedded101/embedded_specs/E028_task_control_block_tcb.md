# E028: Task Control Block (TCB)

## Objective
- Define the structure to hold task state (stack pointer, status, priority).
...
- Think of **Task Control Block (TCB)** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E028.
...
int ok = (winner == 1);
printf("[E028] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E028_task_control_block_tcb/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E028_task_control_block_tcb/solution.c)
