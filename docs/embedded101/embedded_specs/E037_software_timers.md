# E037: Software Timers

## Objective
- Manage a list of software timers driven by a single hardware tick.
...
- Think of **Software Timers** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E037.
...
int ok = (winner == 1);
printf("[E037] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E037_software_timers/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E037_software_timers/solution.c)
