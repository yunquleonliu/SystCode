# E042: Stack Overflow Check

## Objective
- Check stack canaries during context switch.
...
- Think of **Stack Overflow Check** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E042.
...
int ok = (winner == 1);
printf("[E042] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E042_stack_overflow_check/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E042_stack_overflow_check/solution.c)
