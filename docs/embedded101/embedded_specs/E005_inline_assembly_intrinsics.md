...
## Objective
- Use assembly for special instructions (e.g., `NOP`, `WFI`, or finding the first set bit).
...
- C source: [../../problems/embedded101/embedded/E005_inline_assembly_intrinsics/solution.c](https://github.com/yunquleonliu/SystCode/blob/main/problems/embedded101/embedded/E005_inline_assembly_intrinsics/solution.c)
