...
## Objective
- Implement the background task that runs when no other work is pending (and enters sleep).
...
- Think of **Idle Task** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E031.
...
int ok = (winner == 1);
printf("[E031] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E031_idle_task/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E031_idle_task/solution.c)
