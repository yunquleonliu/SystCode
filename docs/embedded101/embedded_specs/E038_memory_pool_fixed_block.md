...
- Think of **Memory Pool (Fixed Block)** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E038.
...
int ok = (winner == 1);
printf("[E038] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E038_memory_pool_fixed_block/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E038_memory_pool_fixed_block/solution.c)
