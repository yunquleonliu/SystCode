# E054: Jitter Analysis

## Objective
- Measure the variation in periodic task execution.
...
- Think of **Jitter Analysis** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E054.
...
printf("[E054] realtime_core %s\n", ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E054_jitter_analysis/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E054_jitter_analysis/solution.c)
