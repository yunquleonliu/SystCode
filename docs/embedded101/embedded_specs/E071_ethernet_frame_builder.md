# E071: Ethernet Frame Builder

## Objective
- Manually construct an Ethernet II frame (MAC header + payload).
...
- Think of **Ethernet Frame Builder** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E071.
...
int ok = cs != 0;
printf("[E071] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E071_ethernet_frame_builder/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E071_ethernet_frame_builder/solution.c)
