...
## Objective
- Configure hardware filters for CAN ID acceptance.
...
- Think of **CAN Bus Filter** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E069.
...
int ok = cs != 0;
printf("[E069] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E069_can_bus_filter/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E069_can_bus_filter/solution.c)
