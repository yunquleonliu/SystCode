# E033: Counting Semaphore

## Objective
- Extend the semaphore to handle resources with count > 1.
...
- Think of **Counting Semaphore** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E033.
...
int ok = (winner == 1);
printf("[E033] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E033_counting_semaphore/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E033_counting_semaphore/solution.c)
