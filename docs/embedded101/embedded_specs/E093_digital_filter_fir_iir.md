# E093: Digital Filter (FIR/IIR)

## Objective
- Implement a simple low-pass or high-pass filter.

## Background
- Module: DSP & Control (5 Problems)
...
- Think of **Digital Filter (FIR/IIR)** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E093.
...
int ok = (mix == 12288);
printf("[E093] dsp_core q15=%d %s\n", mix, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E093_digital_filter_fir_iir/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E093_digital_filter_fir_iir/solution.c)
