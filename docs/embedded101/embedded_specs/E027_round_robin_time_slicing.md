# E027: Round-Robin Time Slicing

## Objective
- Implement preemptive switching using a hardware timer tick.
...
- Think of **Round-Robin Time Slicing** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E027.
...
int ok = (winner == 1);
printf("[E027] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E027_round_robin_time_slicing/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E027_round_robin_time_slicing/solution.c)
