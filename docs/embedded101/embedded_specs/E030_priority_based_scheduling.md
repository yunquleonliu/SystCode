# E030: Priority-Based Scheduling

## Objective
- Implement a scheduler that always picks the highest priority ready task.
...
- Think of **Priority-Based Scheduling** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E030.
...
int ok = (winner == 1);
printf("[E030] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E030_priority_based_scheduling/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E030_priority_based_scheduling/solution.c)
