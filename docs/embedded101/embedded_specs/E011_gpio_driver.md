...
## Objective
- Implement a generic GPIO driver with set/clear/toggle and input buffering.
...
- C source: [../../problems/embedded101/embedded/E011_gpio_driver/solution.c](https://github.com/yunquleonliu/SystCode/blob/main/problems/embedded101/embedded/E011_gpio_driver/solution.c)
