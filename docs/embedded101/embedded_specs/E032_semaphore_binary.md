# E032: Semaphore (Binary)

## Objective
- Implement a blocking binary semaphore.
...
- Think of **Semaphore (Binary)** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E032.
...
int ok = (winner == 1);
printf("[E032] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E032_semaphore_binary/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E032_semaphore_binary/solution.c)
