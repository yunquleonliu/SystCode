# E029: Context Switch (Assembly)

## Objective
- Save and restore CPU registers (R0-R15, PSR) during a task switch.
...
- Think of **Context Switch (Assembly)** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E029.
...
int ok = (winner == 1);
printf("[E029] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E029_context_switch_assembly/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E029_context_switch_assembly/solution.c)
