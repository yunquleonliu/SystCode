# E009: Function Call Conventions (ABI)

## Objective
- Manually parse the stack frame to retrieve arguments of a previous function call.
...
- C source: [../../problems/embedded101/embedded/E009_function_call_conventions_abi/solution.c](https://github.com/yunquleonliu/SystCode/blob/main/problems/embedded101/embedded/E009_function_call_conventions_abi/solution.c)
