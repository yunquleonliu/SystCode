# E072: ARP Request/Reply

## Objective
- Implement the Address Resolution Protocol state machine.
...
- Think of **ARP Request/Reply** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E072.
...
int ok = cs != 0;
printf("[E072] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E072_arp_request_reply/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E072_arp_request_reply/solution.c)
