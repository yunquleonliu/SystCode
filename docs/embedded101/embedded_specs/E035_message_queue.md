...
## Objective
- Implement a thread-safe FIFO queue for passing data between tasks.
...
- Think of **Message Queue** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E035.
...
int ok = (winner == 1);
printf("[E035] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E035_message_queue/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E035_message_queue/solution.c)
