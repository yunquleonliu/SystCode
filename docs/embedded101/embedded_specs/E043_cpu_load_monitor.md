# E043: CPU Load Monitor

## Objective
- Calculate CPU usage percentage per task.
...
- Think of **CPU Load Monitor** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E043.
...
int ok = (winner == 1);
printf("[E043] rtos_core winner=%d %s\n", winner, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E043_cpu_load_monitor/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E043_cpu_load_monitor/solution.c)
