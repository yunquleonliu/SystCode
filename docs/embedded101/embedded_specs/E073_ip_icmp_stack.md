...
int ok = cs != 0;
printf("[E073] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E073_ip_icmp_stack/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E073_ip_icmp_stack/solution.c)
