...
## Objective
- Handle variable length payloads in CAN-FD.
...
- Think of **CAN-FD Payload** as a system behavior problem before it is a coding problem.
...
- This spec serves as the detailed draft for E070.
...
int ok = cs != 0;
printf("[E070] comms_core csum=0x%04X %s\n", cs, ok ? "PASS" : "FAIL");
return ok ? 0 : 1;
```


## Reference Implementation
- C source: [../../problems/embedded101/E070_can_fd_payload/solution.c](https://raw.githubusercontent.com/yunquleonliu/SystCode/main/problems/embedded101/E070_can_fd_payload/solution.c)
