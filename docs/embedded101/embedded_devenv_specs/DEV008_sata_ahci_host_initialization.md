# DEV008: SATA AHCI Host Initialization

## Objective
- Bring up AHCI controller, enumerate ports, and execute IDENTIFY command path.
...
- C source: [../../problems/embedded101/embedded_devenv/DEV008_sata_ahci_host_initialization/solution.c](https://github.com/yunquleonliu/SystCode/blob/main/problems/embedded101/embedded_devenv/DEV008_sata_ahci_host_initialization/solution.c)
