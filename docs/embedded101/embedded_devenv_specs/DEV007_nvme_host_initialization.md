# DEV007: NVMe Host Initialization

## Objective
- Initialize an NVMe controller over PCIe, create admin queues, and run identify/read command sequence.
...
- C source: [../../problems/embedded101/embedded_devenv/DEV007_nvme_host_initialization/solution.c](https://github.com/yunquleonliu/SystCode/blob/main/problems/embedded101/embedded_devenv/DEV007_nvme_host_initialization/solution.c)
